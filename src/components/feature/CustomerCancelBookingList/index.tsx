...
const CustomerCancelBookingListComponent = () => {
    ...
    const fetchUserBookingList = async () => {
      ...
      try {
        const response = await getMethod(
          endPoints.Customer.getCancelRentAllByuserId(UserId),
        );
...
export default CustomerCancelBookingListComponent;
