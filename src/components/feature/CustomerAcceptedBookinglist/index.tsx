...
const CustomerAcceptedBookingListComponent = () => {
    ...
    const fetchUserBookingList = async () => {
      ...
      try {
        const response = await getMethod(
          endPoints.Customer.getAcceptedRentAllByuserId(UserId),
        );
            ...
            <div className=" my-4">
              {userBookingList.length > 0 ? (
                ...
                <div className=" min-h-screen flex justify-center items-center ">
                    <h1 className=" text-xl font-semibold text-red-600 text-center ">No Accepted Booking Aailable</h1>
                </div>
              )}
            </div>
          </div>
...
export default CustomerAcceptedBookingListComponent;
