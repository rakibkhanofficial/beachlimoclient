          ...
          {Cardata?.map((data, index) => (
            ...
            >
              <div className=" grid w-full grid-cols-12">
                <div className="col-span-5 flex items-center justify-center rounded-l-md border p-3 dark:hover:bg-zinc-800">
                  <Image
                    width={200}
                    height={200}
                    alt={data?.Carname}
                ...
                <div className="col-span-7 rounded-r-md border p-3 dark:hover:bg-zinc-800">
