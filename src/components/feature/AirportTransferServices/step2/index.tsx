...
const LocationSelection = () => {
  ...
  return (
    <div className="relative w-full px-2 text-black dark:text-white">
      ...
      <div
        className={`fixed bottom-0 z-50 left-0 flex w-full items-center justify-center bg-white px-2 py-2 transition-transform duration-300 dark:bg-gray-800 ${isScrolling ? "translate-y-full" : "translate-y-0"}`}
      >
        <Button
