...
const CarSelection = () => {
  ...
  return (
    <div className="relative min-h-screen w-full rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
