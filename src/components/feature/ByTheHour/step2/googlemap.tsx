  ...
  return isLoaded ? (
    ...
    >
      ...
      <button
        type="button"
        title="gps"
        className="absolute top-20 right-3 z-[1] dark:text-black p-[6px] hover:text-blue-800 bg-white border shadow-lg border-gray-100 rounded-sm cursor-pointer flex gap-2 justify-center items-center"
